...
public class Haus {
	...
	public Wohnung neueWohnung() {
		...
		//Zufallszahlen
		//Ein Wert für eine Quadratmeterzahl qm aus dem Wertebereich 20, 40, 60, 80, 100
		// 1. Variante: Array
		...
		//Ein Wert für die Anzahl der Zimmer anzZimmer aus dem Wertebereich 1, 2, 3, 4, 5
		int anzZimmer = 1 + r.nextInt(5);
		
		//Ein Wert für die etage aus dem Wertebereich 0, 1, 2, 3, 4, 5
		int etage = r.nextInt(6);

		//Ein Wert für den Mietpreis pro Quadratmeter qmMiete aus dem Wertebereich 8.0, 8.5, 9.0, 9.5, 10.0, 10.5, 11.0, 11.5, 12.0, 12.5
		//Variante 1
	...
	// parametrisierte Konstruktor. Wohnung Array ist mit Objekten Typ Wohnung gefüllt. Für jedes Element des wohnungen-Arrays die Objektmethode neueWohnung() wird aufgerufen.
	...
	//Objektmethode, die gibt ein Wohnung[] Array zurück mit alle die in etage liegen.
	...
	//Diese Methode gibt das als Parameter übergebene wohnungen-Array auf der Konsole aus, in der Form, die wir haben schon in Klasse Wohnung in Methode toString ausgegeben
