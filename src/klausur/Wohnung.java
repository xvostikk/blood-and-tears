...
public class Wohnung {
	...
	public boolean billiger(Wohnung w) {
		/*
		 * if (gesamtMiete() < w.gesamtMiete()) { return true; } else { return false; }
		 */
	...
	public String toString() {
		if (etage == 0) {
			return anzZimmer + "-Zimmer Wohnung mit " + qm + " qm im Erdgeschoss. " + "Monatliche Miete: "
					+ gesamtMiete() + " Euro";
		} else {
			return anzZimmer + "-Zimmer Wohnung mit " + qm + " qm in der " + etage + ". etage.  Monatliche Miete: "
					+ gesamtMiete() + " Euro";
		}
